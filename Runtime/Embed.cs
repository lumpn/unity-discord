...
namespace Lumpn.Discord
{
    ...
    public struct Embed
    {
        ...
        internal Embed Bake(List<FileData> outFiles)
        {
            author = author.Bake(outFiles);
            thumbnail = thumbnail.Bake(outFiles);
            image = image.Bake(outFiles);
            footer = footer.Bake(outFiles);
            return this;
        }
    }
}
